...
let actionMap = {
    init: {
        ...
        usages: ['scaffold init templateName projectName']
    },
    config: {
        alias: 'cfg',
        description: 'config .scaffoldrc',
        usages: ['scaffold config set <k> <v>', 'scaffold config get <k>', 'scaffold config remove <k>']
